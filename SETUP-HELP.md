# Horror: The Voice - Setup help

Everything you need to get **Horror: The Voice** running, step by step. If something goes wrong, check *Troubleshooting* at the end.
...
- Create a **new world with cheats enabled** and activate both packs.
- Operators control the story: `/scriptevent horror:menu`, `horror:pause`, `horror:start`, `horror:reset`.
- The story advances with **in-game days** - sleep or wait. Water is always safe.
